...
public class Reportes {
    ...
    *********************************************************************** */
    public void ReportesClientes() {
        ...
        try {
            PdfWriter.getInstance(documento, new FileOutputStream("C:\\Users\\illuc\\OneDrive\\Escritorio/Reporte_Clientes.pdf"));
            Image header = Image.getInstance("src/img/headerPDF.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
            Paragraph parrafo = new Paragraph();
            parrafo.setAlignment(Paragraph.ALIGN_CENTER);
            parrafo.add("Reporte creado por \nAbner Illú © Tienda Tecnológica\n\n");
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement(
                        "select idCliente, concat(nombre, ' ', apellido) as nombres, DPI, telefono, direccion from tb_cliente");
    ...
    *********************************************************************** */
    public void ReportesProductos() {
        Document documento = new Document();
        try {
            PdfWriter.getInstance(documento, new FileOutputStream("C:\\Users\\illuc\\OneDrive\\Escritorio/Reporte_Productos.pdf"));
            Image header = Image.getInstance("src/img/headerPDF.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesCategorias() {
        Document documento = new Document();
        try {
            PdfWriter.getInstance(documento, new FileOutputStream("C:\\Users\\illuc\\OneDrive\\Escritorio\\Reporte_Categorias.pdf"));
            Image header = Image.getInstance("src/img/headerPDF.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesVentas() {
        Document documento = new Document();
        try {
            PdfWriter.getInstance(documento, new FileOutputStream("C:\\Users\\illuc\\OneDrive\\Escritorio/Reporte_Ventas.pdf"));
            Image header = Image.getInstance("src/img/headerPDF.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
